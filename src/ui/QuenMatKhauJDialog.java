...
public class QuenMatKhauJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnGuiMa.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        btnXacNhanMa.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hinh/back.png"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnXacNhanMa, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnXacNhanMa, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap())))
        );
    ...
    private void txtMaXacNhanKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMaXacNhanKeyReleased
        ValidateForm.mauTrang(txtMaXacNhan);
        ...
        try {
            ...
            Session s = Session.getInstance(p,
                ...
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("duylnkps15921@fpt.edu.vn", "15102002zxc");
                }
            });

            randNum = rand.nextInt(1000000) + 1;
            nv = Auth.user;
           
            String email = nv.getEmail();
            System.out.println(randNum);

            String subject = "Mã xác nhận của bạn là";
            String body = String.valueOf(randNum);

            Message msg = new MimeMessage(s);
            //msg.setFrom(new InternetAddress("d"));// k có cũng đc
    ...
    private void xacNhanMa() {
        String maXacNhan = String.valueOf(randNum);
        System.out.println(maXacNhan);

        if (!ValidateForm.motRongMotSai(txtMaXacNhan, this, maXacNhan, "Vui lòng nhâp mã xác nhận", "Sai mã xác nhận!")) {
            return;
        } else {
            Auth.user = nv;
            MsgBox.alert(this, "Thành công");
            this.dispose();
            new MatKhauMoi(null, true).setVisible(true);
        }
    }
}
